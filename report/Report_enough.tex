...
rationalnum.cpp
\lstinputlisting[]
{../subdirprojectt/cpplib/rationalnum.cpp}}
...
\begin{enumerate}
	...
	QuadEquationClass.h
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/QuadEquationClass.h}
	
	\vspace{\baselineskip}
	
	QuadEquationClass.cpp
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/QuadEquationClass.cpp}
	
	\item Класс Date для работы с датой и временем.
	
	date.h
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/date.h}
	
	\vspace{\baselineskip}
	
	date.cpp
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/date.cpp}
	
	\item Класс Factorizator для разложения числа на простые множители.
	
	Factorizator.h
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/Factorizator.h}
	
	\vspace{\baselineskip}
	
	Factorizator.cpp
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/Factorizator.cpp}
	
	\item Класс ArraySplitter для разбиения массива.
	
%	arraysplitter.h
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/arraysplitter.h}
	
%	arraysplitter.сpp
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/arraysplitter.cpp}	
	
	\item Класс Drug, медикамент.
		
%	drug.h
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/drug.h}
	
%	drug.сpp
%	\lstinputlisting[]
%	{../sources/subdirproject/cpplib/drug.cpp}	
...
%		exceptions.h
%		\lstinputlisting[]
%		{../sources/subdirproject/cpplib/exceptions.h}
\section{Автоматические тесты}

%	\lstinputlisting[]{../sources/subdirproject/cpptest/tst_cpptesttest.cpp}
	
	
%	\lstinputlisting[]{../sources/subdirproject/test3/tst_test3test.cpp}
